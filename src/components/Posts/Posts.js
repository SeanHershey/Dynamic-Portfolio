...
const Posts = () => {
    const blogPosts = [
        ...
        body: `Cat and Mouse Forest is a game based on
        a Java repository that I refactored to align 
        with principles of abstraction and implementing
        creational, structural, and behavioral patterns.
        The original game had the functionality of
        cutting trees and returning wood to the cabins,
        where the trees could be regrown by fairies.
        I added to this with a mouse infestation. 
        These mice are spawned by clicking the ground 
        and slowly destroy the cabins. The game can 
        again be brought to balance by clicking next to
        a fairy which transforms it into a cat who hunts
        mice.`,
        imgUrl:
        ...
        body: `This report details the Pacman M1 chip 
        vulnerability and is written in three different
        mediums and for three different audiences. 
        The first is an online article explaining the 
        Pacman exploit to a general audience who may 
        not have any computer science knowledge. This 
        is critical for my path as a computer science 
        major, because I need to collaborate with others 
        by explaining my work and its impacts to people 
        with all sorts of backgrounds. The second medium 
        in this paper is an executive summary which 
        takes on a more business centered explanation 
        of Pacman. This will also be a part of my future 
        as working within a company involves many memos, 
        meetings, and even emails. Finally, the third 
        medium contained in this paper is an IEEE 
        compliant technical report research paper. This 
        includes the most detail and is meant for an 
        informed computer scientist in academia. Showing 
        that I can write about the same issue and allow 
        the audience and medium to reflect on how I write 
        shows that I can be adaptive and diverse in my 
        skills. `,
        imgUrl:
        ...
        imgUrl:
            "https://i.ibb.co/HgVnhFH/spider.png",
        },
        {
        title: "Huffman",
        body: `Huffman coding works by assigning data, 
        in this implementation characters, to a 
        variable-length binary representation of a tree. 
        The more frequently used a character is the closer 
        to the root and shorter the binary representation. 
        For example, 'a' may get 001 while 'z' may have 
        the longer representation of 1010010. I implemented 
        my Huffman encode and decode in python. In the 
        Huffman output file, I appended a header to 
        translate this data with a tree where we know when 
        a ends in 0011010010 by traversing the tree. This
        project helped me understand the fundamentals
        of computer algorithms and along with proofs gave
        me a better grounding for more complex algorithms.`,
        imgUrl:
            "https://i.ibb.co/vVpVxq4/huffman.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/5FYJfp9/concordance.png",
        },
        {
        ...
        strategies.`,
        imgUrl:
            "https://i.ibb.co/7rxYjmc/twocolorable.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/mcyzrsd/bignumber.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/yWz1h47/calculator.png",
        },
        {
        ...
        other ecalls.`,
        imgUrl:
            "https://i.ibb.co/6vNKZb9/ecalls.png",
        },
        {
        title: "Assembler",
        ...
        imgUrl:
            "https://i.ibb.co/fCwmNFj/assembler.png",
        },
        {
        title: "Emulator",
        ...
        imgUrl:
            "https://i.ibb.co/W5SdZ3m/emulator.png",
        },
        {
        title: "Computer Architecture Simulations",
        body: `First, I created a 5-stage piped CPU simulator
        which reports step by step the stages while keeping
        track of registers with an emulator. The idea of a 
        piped CPU is to allow multiple instruction to be 
        concurrently in the CPUs various stages. To achieve 
        this stall must be added for back-to-back dependent 
        instructions like x = 1 then x++. The next modification 
        I simulated is a branch predictor. When jumping to 
        different sections of code based on conditionals we 
        would have to stall until the jump was calculated but 
        if we could predict the jump, we could load those 
        instructions into the pipe. Finally, a cache simulation 
        allowed for testing of size, associativity, and block 
        size effect on cache hit rate. A higher cache hit rate 
        translates to data that can be looked up easily by the 
        CPU without needing to access disk or slower memory. `,
        imgUrl:
            "https://i.ibb.co/JjGDVdT/simulations.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/MMRYjY2/otw.png",
        },
        {
            ...
            hardware.  `,
            imgUrl:
                "https://i.ibb.co/YfP7WNZ/micro.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/60cWJRF/symmetric.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/zsZVDR7/public.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/7rrRtdG/aws.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/N3j8pPR/wireshark.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/4Ss9StB/memory.png",
        },
        {
        ...
        this project.`,
        imgUrl:
            "https://i.ibb.co/S37tGgz/compress.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/bFfrRDT/files.png",
        },
        {
        ...
        problems.`,
        imgUrl:
            "https://i.ibb.co/nmYSmWL/parallel.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/x3P6Hjk/structural.png",
        },
        {
        ...
        imgUrl:
            "https://i.ibb.co/RQH6LSD/everest.png",
        },
        {
        title: "Printer Toners",
        body: `This project was done while working for my highschool.
        The application used web scraping on a WAN in order to collate
        ...
        imgUrl:
            "https://i.ibb.co/H4qb0FD/printer.png",
        },
        {
        ...
        even video games in.`,
        imgUrl:
            "https://i.ibb.co/GVY0Bqh/mandelbrot.png",
        },
        {
        title: "Dynamic Portfolio",
        body: `This website is created in react with a focus on 
        dynamic scaling and showcasing my work over the years.`,
        imgUrl:
            "https://i.ibb.co/gSDNsKG/dynamic.png",
        },
        {
        ...
        image generation.`,
        imgUrl:
            "https://i.ibb.co/LxrPvvf/stable.png",
        },
    ];
